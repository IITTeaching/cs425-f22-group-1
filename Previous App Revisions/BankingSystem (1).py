...
def toDeposit():
    ...
    Label(toDeposit_screen,text="Please Confirm Your SSN: ",font=('Times New Roman',d)).grid(row=0,sticky=N,pady=10,padx=10)
...
def toWithdraw():
    ...
    Label(toWithdraw_screen,text="Please Confirm Your SSN: ",font=('Times New Roman',d)).grid(row=0,sticky=N,pady=10,padx=10)
